...
public class FindArtikelToYourBil {
    ...
    String bilregisteringsnummer="GCJ80K";

    public String getBilregisteringsnummer() {
        return bilregisteringsnummer;
    }
    ...
    public FindArtikelToYourBil(Page page){
           ...
           this.vhus = page
            ...
            this.bilregisteringsnummer = bilregisteringsnummer;
        ...
        public void enterYourBilRegisteringsNummer(){
                ...
                registeringsNummer.fill("GCJ80K");
